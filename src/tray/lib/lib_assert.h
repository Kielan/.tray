...
/* Util fns. */
void _lib_assert_print_pos(const char *file, int line, const char *fn, const char *id);
void _lib_assert_print_extra(const char *str);
void _lib_assert_print_backtrace(void);
void _lib_assert_abort(void);
void _lib_assert_unreachable_print(const char *file, int line, const char *fn);
