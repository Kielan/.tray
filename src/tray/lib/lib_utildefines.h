...
#define ARRAY_DELETE(arr, index, delete_len, arr_len) \
  { \
    lib_assert((&arr[index] >= arr) && ((index) + delete_len <= arr_len)); \
    memmove(&(arr)[index], \
...
/* Pointer Macros */
#if defined(__GNUC__) || defined(__clang__)
#  define PTR_OFFSET(v, ofs) ((typeof(v))((char *)(v) + (ofs)))
#else
#  define PTR_OFFSET(v, ofs) ((void *)((char *)(v) + (ofs)))
#endif

/* Warning-free macros for storing ints in pointers. Use these _only_
 * for storing an int in a pointer, not a pointer in an int (64bit)! */
#define PTR_FROM_INT(i) ((void *)(intptr_t)(i))
#define PTR_AS_INT(i) ((void)0, ((int)(intptr_t)(i)))

#define PTR_FROM_UINT(i) ((void *)(uintptr_t)(i))
#define PTR_AS_UINT(i) ((void)0, ((unsigned int)(uintptr_t)(i)))
...
/* Unused Fn/Argument Macros */
/* UNUSED macro, for fn argument */
#if defined(__GNUC__) || defined(__clang__)
 ...
 * Use UNUSED_FN_WITH_RETURN_TYPE instead in this case. */
#if defined(__GNUC__) || defined(__clang__)
#  define UNUSED_FN(x) __attribute__((__unused__)) UNUSED_##x
#else
#  define UNUSED_FN(x) UNUSED_##x
#endif

#if defined(__GNUC__) || defined(__clang__)
#  define UNUSED_FN_WITH_RETURN_TYPE(rtype, x) __attribute__((__unused__)) rtype UNUSED_##x
#else
#  define UNUSED_FN_WITH_RETURN_TYPE(rtype, x) rtype UNUSED_##x
#endif
